/* ------------------------------------------------------------------
    MaierSaupe - Theoretically Informed Langevan Dynamics
    This replicates the MaierSaupe coe done by the Riggleman group, 
...
KSpaceStyle(maier-saupe,MaierSaupe)

#else

#ifndef LMP_MaierSaupe_H
#define LMP_MaierSaupe_H

#include "kspace.h"

namespace LAMMPS_NS {

class MaierSaupe : public KSpace{
 public:
  MaierSaupe (class LAMMPS *);
  virtual ~MaierSaupe();
  virtual void init();
  virtual void setup();
